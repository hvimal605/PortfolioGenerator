        ...
        >
          ...
          <form onSubmit={handleVerifyAndSignup} className="space-y-4">
            <OtpInput
              ...
              renderInput={(props) => (
                <input
                  ...
                  className="w-[48px] lg:w-[60px] border border-cyan-800 bg-richblack-800 rounded-[0.5rem]  aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-50  text-white placeholder:text-amber-100 placeholder:text-2xl"
                />
              )}
              containerStyle={{
            ...
            <motion.button
              ...
              className="w-full bg-cyan-300 py-3 rounded-lg text-black font-semibold hover:bg-cyan-400 transition-all"
            >
              Verify Email
            </motion.button>
          </form>
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <button className="text-blue-300 flex items-center gap-x-2"
