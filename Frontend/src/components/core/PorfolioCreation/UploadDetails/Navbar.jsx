...
const Navbar = ({ steps, currentStep }) => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <div className="hidden sm:flex fixed top-24 left-1/2 transform -translate-x-1/2 justify-center items-center bg-gradient-to-br from-[#1a1a1a] via-[#111] to-[#0f0f0f] backdrop-blur-lg p-5 rounded-xl shadow-xl border border-gray-600 w-[95%] max-w-6xl overflow-x-auto z-40 no-scrollbar">
      ...
      {/* Sidebar Mobile */}
      <div
        className={`fixed top-20 left-0 w-64 h-full bg-black bg-opacity-90 p-6 transform ${
